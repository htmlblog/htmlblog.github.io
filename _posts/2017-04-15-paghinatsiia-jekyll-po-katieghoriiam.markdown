...
Начнем с главной - откройте в корне сайта файл *index.html*. В шапке где задается *title* и *layout* добавляем код:
>pagination:
>>enabled: true
...
Важно! Для главной страницы сайта! Замените в коде ссылок *'/news/'* на *'/'*.
