...
После перезапуска сервера по адресу *localhost:4000/sport/* будут выводится посты из категории *sport* по 4 штуки на страницу. Если требуется изменить число выводимых постов то добавьте в шапку параметр:
